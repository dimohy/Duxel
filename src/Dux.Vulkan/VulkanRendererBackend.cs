...
public sealed unsafe class VulkanRendererBackend : IRendererBackend
{
    ...
    private static readonly byte[] VertexShaderSpirv = LoadEmbeddedShader("Dux.Vulkan.Shaders.imgui.vert.spv");
    private static readonly byte[] FragmentShaderSpirv = LoadEmbeddedShader("Dux.Vulkan.Shaders.imgui.frag.spv");
    ...
    public VulkanRendererBackend(IPlatformBackend platform, VulkanRendererOptions options)
    {
        ...
        _pipelineCachePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Dux", "vulkan_pipeline_cache.bin");
    ...
    private unsafe void CreateInstance()
    {
        ...
        var appInfo = new ApplicationInfo
        {
            ...
            PApplicationName = (byte*)SilkMarshal.StringToPtr("Dux"),
            PEngineName = (byte*)SilkMarshal.StringToPtr("Dux"),
