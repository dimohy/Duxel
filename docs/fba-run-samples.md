...
> Run **Duxel** FBA samples with a **single copy-paste command**. These samples use the .NET 10 file-based app feature. Duxel `0.2.11-preview` packages support regular .NET 8, .NET 9, and .NET 10 projects.
